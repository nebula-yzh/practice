 ...
 */
public class S146LRUCache2 {
    public static void main(String[] args) {
        S146LRUCache2 s146LruCache2 = new S146LRUCache2(2);

        s146LruCache2.put(1, 1);
        s146LruCache2.put(2, 2);
        System.out.println(s146LruCache2.get(1));

        s146LruCache2.put(3, 3);
        System.out.println(s146LruCache2.get(2));
        s146LruCache2.put(4, 4);
        System.out.println(s146LruCache2.get(1));
        System.out.println(s146LruCache2.get(3));
        System.out.println(s146LruCache2.get(4));
        //System.out.println(s146LruCache2);
    }
    ...
    public S146LRUCache2(int capacity) {
        //初始化lru链表
